#!/bin/sh
ENV=$2
HOME="/var/javapps/figs-auction-results"
JARFile="$HOME/lib/figs-auction-results.jar"
PIDFile="$HOME/figs-auction-results.pid"
OPTS="--spring.profiles.active=$ENV"
...
start)
	...
	nohup java -jar $JARFile $OPTS >/dev/null 2>&1 &
